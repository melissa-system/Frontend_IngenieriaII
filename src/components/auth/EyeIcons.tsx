// Íconos de mostrar/ocultar contraseña, compartidos por Login, Recuperar y
// Restablecer contraseña (los tres formularios que piden una contraseña).
export function OjoAbiertoIcon() {
  return (
    <svg
...
export function OjoCerradoIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
