function SolicitudesTrasladoMedidor() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-primary-500">
          Solicitudes de traslado de medidor registradas
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-primary-200 bg-white py-16 text-center shadow-sm">
        ...
        <p className="mt-1 text-sm text-primary-400">
          Las solicitudes de traslado de medidor aparecerán aquí.
        </p>
      </div>
    </div>
  )
...
export default SolicitudesTrasladoMedidor